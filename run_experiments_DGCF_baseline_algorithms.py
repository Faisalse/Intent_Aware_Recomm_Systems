...
import traceback, os
from Data_manager.Gowalla_Yelp_Amazon_DGCF import Gowalla_Yelp_Amazon_DGCF 
...
if __name__ == '__main__':
    ...
    model = "DGCF"
    dataset_name = "amazonbook" # yelp2018, gowalla, amazonbook
    dataSetType = "given"
    task = "training"

    validation_set = False
    dataset_object = Gowalla_Yelp_Amazon_DGCF()
    URM_train, URM_test = dataset_object._load_data_from_give_files(validation=validation_set, data_name = dataset_name)
